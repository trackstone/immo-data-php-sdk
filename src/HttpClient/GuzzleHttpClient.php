...
use ImmoData\Sdk\Exceptions\AuthenticationException;
use ImmoData\Sdk\Exceptions\ForbiddenException;
use ImmoData\Sdk\Exceptions\ImmoDataException;
use ImmoData\Sdk\Exceptions\InsufficientCreditsException;
use ImmoData\Sdk\Exceptions\NotFoundException;
use ImmoData\Sdk\Exceptions\RateLimitException;
use ImmoData\Sdk\Exceptions\ServerException;
use ImmoData\Sdk\Exceptions\ValidationException;
use JsonException;
